...
```
soda generate model item id:int alias:string title:string desc:string pictures:string price:int count:int category_id:int
soda generate model category id:int alias:string title:string desc:string logo:string parent_id:int
